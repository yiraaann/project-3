...
def oil_usage():
    ...
    for oil_usage in results:
        oil_usage_dict = {}
        oil_usage_dict["series"] = results[0]
        oil_usage_dict["country"] = results[1]
        oil_usage_dict["code"] = results[2]
        oil_usage_dict["yr2000"] = results[3]
        oil_usage_dict["yr2001"] = results[4]
        oil_usage_dict["yr2002"] = results[5]
        oil_usage_dict["yr2003"] = results[6]
        oil_usage_dict["yr2004"] = results[7]
        oil_usage_dict["yr2005"] = results[8]
        oil_usage_dict["yr2006"] = results[9]
        oil_usage_dict["yr2007"] = results[10]
        oil_usage_dict["yr2008"] = results[11] 
        oil_usage_dict["yr2009"] = results[12] 
        oil_usage_dict["yr2010"] = results[13] 
        oil_usage_dict["yr2011"] = results[14]
        oil_usage_dict["yr2012"] = results[15]
        oil_usage_dict["yr2013"] = results[16]
        oil_usage_dict["yr2014"] = results[17]
        oil_usage_dict["yr2015"] = results[18]
...
def life_expectancy():
    ...
    for mobile in results:
        mobile_dict = {}
        mobile_dict["series"] = results[0]
        mobile_dict["country"] = results[1]
        mobile_dict["code"] = results[2]
        mobile_dict["yr2000"] = results[3]
        mobile_dict["yr2001"] = results[4]
        mobile_dict["yr2002"] = results[5]
        mobile_dict["yr2003"] = results[6]
        mobile_dict["yr2004"] = results[7]
        mobile_dict["yr2005"] = results[8]
        mobile_dict["yr2006"] = results[9]
        mobile_dict["yr2007"] = results[10]
        mobile_dict["yr2008"] = results[11] 
        mobile_dict["yr2009"] = results[12] 
        mobile_dict["yr2010"] = results[13] 
        mobile_dict["yr2011"] = results[14]
        mobile_dict["yr2012"] = results[15]
        mobile_dict["yr2013"] = results[16]
        mobile_dict["yr2014"] = results[17]
        mobile_dict["yr2015"] = results[18]
